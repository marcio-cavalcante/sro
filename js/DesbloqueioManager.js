...
function setupBotaoEnviarPendencias() {
    const btnEnviarPendencias = document.getElementById('btnEnviarPendencias');
    
    if (!btnEnviarPendencias) {
        console.warn("Botão 'btnEnviarPendencias' não encontrado. Verifique se ele existe no HTML.");
        return;
    }
    
    // Adicionar evento de clique ao botão
    btnEnviarPendencias.addEventListener('click', enviarEmailPendencias);
}
...
export default DesbloqueioManager;